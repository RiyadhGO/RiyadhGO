 ...
 */
public class ScooterTripFragment extends Fragment implements LocationChangedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_scooter_trip, container, false);
        distanceTV = root.findViewById(R.id.scooter_trip_fgmt_distance_txt);
        timeTV = root.findViewById(R.id.scooter_trip_fgmt_time_txt);
        goSosBtn = root.findViewById(R.id.scooter_trip_fgmt_sos_btn);
    ...
    public void locationChanged(LatLng location) {
        ...
        if(currentMarker == null)
        {
            ...
            currentMarker.setIcon(
                    BitmapDescriptorFactory.fromResource(R.drawable.scooter2));
        }
        else
        {
        ...
        TripsUtil.addPointToScooterTrip(location.latitude,location.longitude);
        updateDistances();
    ...
    private void reachedDestination(){
        if(reached)
            return;
        stopMoving();
        TripsUtil.endScooterTrip(this.currentLocation.latitude, this.currentLocation.longitude);
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                goSosBtn.setText(getString(R.string.GO));
